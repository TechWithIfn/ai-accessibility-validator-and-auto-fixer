        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center space-y-8">
          ...
          >
            ...
            >
              <Link
                href="/scanner"
                className="group relative px-8 py-4 bg-gradient-hero text-white rounded-xl font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
              >
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`inline-flex p-4 rounded-2xl bg-white/50 dark:bg-gray-800/50 mb-6 ${colors.glow} shadow-lg`}
      >
        <Icon className={`w-8 h-8 ${colors.icon}`} aria-hidden="true" />
      </motion.div>
      <h3 className="text-2xl font-bold font-display mb-3 text-gray-900 dark:text-white">
        {title}
      </h3>
  ...
  return (
    ...
    >
      ...
      <div className="glass rounded-2xl p-6 mb-4">
        <div className="w-16 h-16 mx-auto mb-4 bg-gradient-hero rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg">
          {number}
        </div>
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="text-center">
          ...
          <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Accessibility Score</h3>
          <p className="text-sm text-gray-600 dark:text-gray-300">Level AA Compliant</p>
        </div>
...
function Footer() {
  ...
  return (
    <footer className="relative px-4 sm:px-6 lg:px-8 py-16 border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold font-display gradient-text dark:gradient-text-dark mb-4">
